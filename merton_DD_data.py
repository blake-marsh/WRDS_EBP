...
#----------------------------------------------------------
H15 = pd.read_csv("/data/BR_SRA/public_data/data/H15_B.csv", na_values=["."])
...
#------------------------------------------
# match stock prices to balance sheet data
#------------------------------------------
...
# Export the raw data
#---------------------
crsp.to_csv("./data/merton_DD_data_WRDS_1970_1989.txt", sep="|", index=False)
