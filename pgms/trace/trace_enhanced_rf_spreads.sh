...
#$ -pe onenode 8
#$ -l m_mem_free=6G
#$ -o $HOME/WRDS_EBP/unrealized-gains/logfiles/trace_enhanced.o.log
#$ -e $HOME/WRDS_EBP/unrealized-gains/logfiles/trace_enhanced.e.log


cd ~/WRDS_EBP/unrealized-gains/
